...
import type { BlockSubmission, FileUploadBlock as FileUploadBlockType } from '@studyx/types'
import {
...
export function FileUploadBlock({ block, submission, isPreview = false }: FileUploadBlockProps) {
  ...
  const handleFileSelect = useCallback(
    (e: React.ChangeEvent<HTMLInputElement>) => {
      if (!e.target.files || isPreview || isGraded)
        return
