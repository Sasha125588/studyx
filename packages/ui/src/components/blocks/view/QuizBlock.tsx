...
import type { BlockSubmission, QuizBlock as QuizBlockType, QuizQuestion } from '@studyx/types'
import {
...
export function QuizBlock({ block, submission, isPreview = false }: QuizBlockProps) {
  ...
  const getAnswer
    = (questionId: string): Answer | undefined => answers.find(a => a.questionId === questionId)
