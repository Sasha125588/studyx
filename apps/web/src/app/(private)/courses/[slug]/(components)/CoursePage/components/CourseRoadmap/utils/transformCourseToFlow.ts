...
export function transformCourseToFlow(modules: ModuleWithLessons[], options: TransformOptions = {}) {
...
function findSavedPosition(savedPositions: RoadmapPosition[], nodeType: 'module' | 'lesson', nodeId: number) {
