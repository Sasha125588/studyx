    ...
    return (
      ...
      >
        <div
          data-slot="sidebar"
          className={cn(
            'text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col py-1',
            className,
          )}
          {...props}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'bg-sidebar relative w-(--sidebar-width) transition-all duration-300 ease-in-out',
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-300 ease-[cubic-bezier(0.75,0,0.25,1)] md:flex',
          side === 'left'
